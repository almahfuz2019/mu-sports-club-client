        ...
        {isLoading || Object.values(loadingState).some(Boolean) ? (
          ...
          allData.map((item) => (
            ...
            >
              ...
              <TableCell>
                <Mail className="w-4 h-4 text-blue-600 inline mr-1" />
                {item.email}
              </TableCell>
              <TableCell>
                <Phone className="w-4 h-4 text-blue-600 inline mr-1" />
                {item.phone}
              </TableCell>
              <TableCell>
                <MapPin className="w-4 h-4 text-blue-600 inline mr-1" />
                {item.location}
              </TableCell>
              <TableCell>
                <AlertDialog>
