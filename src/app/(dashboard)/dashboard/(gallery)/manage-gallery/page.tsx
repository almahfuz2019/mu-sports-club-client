...
import { useHandleDeleteGalleryMutation, useHandleFindGalleryQuery, useHandleUpdateGalleryStatusMutation, useHandleUpdateGalleryTrashMutation } from "@/Redux/features/gallery/galleryApi";
...
const ManagePage = () => {
  ...
  const { data, isLoading, error, isError } = useHandleFindGalleryQuery({
    page: currentPage,
    limit,
    search: searchText,
    status,
  ...
  const handleDownloadExcel = () => {
    ...
    const url = `${baseURL}/gallery/download-excel?${params}`;
  ...
  return (
    <div>
      <Filters
        ...
        headingTitle="Manage Gallery"
        headingSubtitle="Manage all your gallery items. You can add, or edit them."
      />
