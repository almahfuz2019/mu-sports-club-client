...
import { useHandleCreateGalleryMutation } from "@/Redux/features/gallery/galleryApi";
...
const AddPage = () => {
  ...
  const [handleCreate, { isLoading, error }] = useHandleCreateGalleryMutation();
  ...
  const onSubmit: SubmitHandler<IFormInput> = async () => {
    try {
      ...
      router.push("/dashboard/manage-gallery");
    } catch (error: any) {
  ...
  return (
    <div>
      <Heading
        title="Add Gallery"
        subTitle="Enter information to add a new Gallery to the list."
      />
      <Form {...methods}>
        <form
