...
import { useHandleDeleteAllCommitteeMutation, useHandleFindAllCommitteeQuery, useHandleUpdateAllCommitteeStatusMutation, useHandleUpdateAllCommitteeTrashMutation } from "@/Redux/features/allCommittee/allCommittee";
...
const ManagePage = () => {
  ...
  const { data, isLoading, error, isError } = useHandleFindAllCommitteeQuery({
    page: currentPage,
    limit,
    search: searchText,
    status,
  ...
  const handleDownloadExcel = () => {
    ...
    const url = `${baseURL}/all-committee/download-excel?${params}`;
  ...
  return (
    <div>
      <Filters
        ...
        headingTitle="Manage All Committees"
        headingSubtitle="Manage all your all committees. You can add, or edit them."
      />
