...
const ManagePage = () => {
  ...
  const { data, isLoading, error, isError } = useHandleFindSponsorQuery({
    page: currentPage,
    limit,
    search: searchText,
    status,
  ...
  const handleDownloadExcel = () => {
    ...
    const url = `${baseURL}/sponsor/download-excel?${params}`;
  ...
  return (
    <div>
      <Filters
        ...
        headingTitle="Manage Sponsors"
        headingSubtitle="Manage all your sponsors. You can add, or edit them."
      />
