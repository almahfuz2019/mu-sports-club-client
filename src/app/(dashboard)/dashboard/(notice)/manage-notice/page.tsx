...
import { useHandleDeleteNoticeMutation, useHandleFindNoticeQuery, useHandleUpdateNoticeStatusMutation, useHandleUpdateNoticeTrashMutation } from "@/Redux/features/notice/noticeApi";
...
const ManagePage = () => {
  ...
  const { data, isLoading, error, isError } = useHandleFindNoticeQuery({
    page: currentPage,
    limit,
    search: searchText,
    status,
  ...
  const handleDownloadExcel = () => {
    ...
    const url = `${baseURL}/notice/download-excel?${params}`;
  ...
  return (
    <div>
      <Filters
        ...
        headingTitle="Manage Notices"
        headingSubtitle="Manage all your notices. You can add, or edit them."
      />
