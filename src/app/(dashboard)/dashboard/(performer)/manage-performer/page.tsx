...
import { useHandleDeletePerformerMutation, useHandleFindPerformerQuery, useHandleUpdatePerformerStatusMutation, useHandleUpdatePerformerTrashMutation } from "@/Redux/features/performer/performerApi";
...
const ManagePage = () => {
  ...
  const { data, isLoading, error, isError } = useHandleFindPerformerQuery({
    page: currentPage,
    limit,
    search: searchText,
    status,
  ...
  const handleDownloadExcel = () => {
    ...
    const url = `${baseURL}/performer/download-excel?${params}`;
  ...
  return (
    <div>
      <Filters
        ...
        headingTitle="Manage Performers"
        headingSubtitle="Manage all your performers. You can add, or edit them."
      />
