...
import { useHandleDeleteStatsMutation, useHandleFindStatsQuery, useHandleUpdateStatsStatusMutation, useHandleUpdateStatsTrashMutation } from "@/Redux/features/stats/statsApi";
...
const ManagePage = () => {
  ...
  const { data, isLoading, error, isError } = useHandleFindStatsQuery({
    page: currentPage,
    limit,
    search: searchText,
    status,
  ...
  const handleDownloadExcel = () => {
    ...
    const url = `${baseURL}/stats/download-excel?${params}`;
  ...
  return (
    <div>
      <Filters
        ...
        headingTitle="Manage Stats"
        headingSubtitle="Manage all your stats. You can add, or edit them."
      />
