...
import { useHandleCreateEventCategoryMutation } from "@/Redux/features/eventCategory/eventCategoryApi";
...
const AddPage = () => {
  ...
  const [handleCreateEventCategory, { isLoading, error }] =
  ...
  const onSubmit: SubmitHandler<IFormInput> = async () => {
    try {
      ...
      await handleCreateEventCategory(payload).unwrap();
  ...
  return (
    <div>
      <Heading
        ...
        subTitle="Enter information to add a new Event Category to the list."
      />
      <Form {...methods}>
        <form
        ...
        >
          ...
          >
            {isLoading ? "Please Wait..." : "Add Event Category"}
          </Button>
