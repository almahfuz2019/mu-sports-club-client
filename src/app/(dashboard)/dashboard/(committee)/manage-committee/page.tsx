...
const ManagePage = () => {
  ...
  const { data, isLoading, error, isError } = useHandleFindCommitteeQuery({
    page: currentPage,
    limit,
    search: searchText,
    status,
  ...
  const handleDownloadExcel = () => {
    ...
    const url = `${baseURL}/committee/download-excel?${params}`;
  ...
  return (
    <div>
      <Filters
        ...
        headingTitle="Manage Committees"
        headingSubtitle="Manage all your committees. You can add, or edit them."
      />
