...
import { useHandleCreateCommitteeMutation } from "@/Redux/features/committee/committeeApi";
...
const AddPage = () => {
  ...
  return (
    <div>
      <Heading
        title="Add Committee"
        subTitle="Enter information to add a new Committee to the list."
      />
      <Form {...methods}>
        <form
        ...
        >
          ...
          >
            {isLoading ? "Please Wait..." : "Add Committee"}
          </Button>
